...
Usage: simulate_synteny.py -s <INT> -k <INT> -g <INT> -a <FLT> -r <STR> -i <FLT> -e <FLT> -t <STR> [-M <INT> -h]
...
for i in range(0, s_arg):
	...
	parameterObj = ParameterObj(simulated_syngraph, tree, 3, "quick", ms_arg)
